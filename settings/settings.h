...
struct Settings
{
  ...
  std::string discretizationType = "DC";    //< CD = CentralDifferences and DC = DonorCell
  double alphaDC = 0.5;                     //< factor for donor-cell scheme
  ...
  double omegaSOR = 1.0;                    //< overrelaxation factor
  double epsilonTol = 1e-5;                 //< tolerance for the residual in the pressure solver
  int maxPressureIterations = 1e5;          //< maximum number of iterations in the solver
